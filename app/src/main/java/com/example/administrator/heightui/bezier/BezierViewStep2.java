 ...
 * 曲线绘制
 */
public class BezierViewStep2 extends View {
    ...
    public BezierViewStep2(Context context) {
        this(context,null);
    }

    public BezierViewStep2(Context context, @Nullable AttributeSet attrs) {
    ...
    public BezierViewStep2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
